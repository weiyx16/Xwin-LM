...
# def generate_prompt(input, prompt_type):
#     # task = extract_text(input)
#     prompt_dict = {
#         "WizardCoder": f"""Below is an instruction that describes a task. Write a response that appropriately completes the request.
...
# {input}
# <AI>: """,
#         "test": f"""<system>: You are an AI coding assistant that helps people with programming. Write a response that appropriately completes the user's request.
# <user>: 
# {input}
# <AI>: """
#     }
